  ...
  return (
    <div className="absolute bottom-4 left-4 z-10 p-4 bg-gray-800 bg-opacity-70 rounded-lg shadow-lg text-white w-64 font-sans">
      ...
      <div className="space-y-1 text-sm">
        ...
        <p>Longitude: <span className="font-mono float-right">{issData.lng.toFixed(4)}°</span></p>
        <p>Altitude: <span className="font-mono float-right">{issData.alt.toFixed(2)} km</span></p>
        <p>Speed: <span className="font-mono float-right">{issData.vel.toFixed(2)} km/h</span></p>
      </div>
